...
public class BinaryFileIO {
    ...
    public class LoanDemo {
        ...
        public static void main (String[] args) {
            ...
            // todo: OPEN BINARY FILE with output stream
            try {
                outStream = new ObjectOutputStream(new FileOutputStream(fileName));

                // todo: WRITE OBJECTS to binary file
                for (int i = 0; i < 3; i ++) {
            ...
            // todo: APPEND OBJECTS to stream using AppendObjectOutputStream (custom override class)
            try {
                // Set append to true
            ...
            // todo: READ OBJECTS from file and display in report
